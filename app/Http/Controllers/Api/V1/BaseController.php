...
class BaseController extends Controller
{
    ...
    public function sendSms($message, $phone)
    {
        ...
        if(!in_array($_SERVER['REMOTE_ADDR'], $whitelist))
        {
            ...
            $url = "https://www.jawalbsms.ws/api.php/sendsms?user=".$username."&pass=".$password."&to=".$phone."&message=".$message."&sender=".$sender."&unicode=u";
    ...
    // === Get all services ===
    protected function getServices($id = null)
    {
        if($id)
        {
